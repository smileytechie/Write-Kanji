...
<div class="outline-color"></div>
<div class="drawing-color"></div>
`;
document.getElementById("bottom-Button").innerHTML = colors_used1;
...
//Modified as detailed by krmani
//https://stackoverflow.com/questions/50513063/anki-and-ankidroid-importing-json-from-collection-media-with-javascript
//https://github.com/krmanik/Anki-xiehanzi
/*! Hanzi Writer v2.2.2 | https://chanind.github.io/hanzi-writer */
! function(t, i) {
    "object" == typeof exports && "object" == typeof module ? module.exports = i() : "function" == typeof define && define.amd ? define([], i) : "object" == typeof exports ? exports.HanziWriter = i() : t.HanziWriter = i()
    ...
    return function(n) {
        ...
        return o.m = n, o.c = r, o.d = function(t, i, n) {
        ...
        (function(t) {
            ...
            var i = t.performance && function() {
                    return t.performance.now()
                } || function() {
                    return Date.now()
                },
                n = t.requestAnimationFrame || function(t) {
                ...
                o = function(t) {
                    for (var n = Object(t), i = arguments.length, r = Array(1 < i ? i - 1 : 0), o = 1; o < i; o++) r[o - 1] = arguments[o];
            ...
            var e = t.navigator && t.navigator.userAgent || "",
                a = 0 < e.indexOf("MSIE ") || 0 < e.indexOf("Trident/") || 0 < e.indexOf("Edge/");
            c.exports = {
                e: o,
                arrLast: function(t) {
                    return t[t.length - 1]
                ...
                copyAndMergeDeep: function t(i, n) {
                    ...
                    for (var o in n) {
                        var s = i[o],
                            e = n[o];
                        s !== e && (s && e && "object" === (void 0 === s ? "undefined" : u(s)) && "object" === (void 0 === e ? "undefined" : u(e)) && !Array.isArray(e) ? r[o] = t(s, e) : r[o] = e)
                    }
                    return r
                },
                counter: function() {
        ...
        try {
            Ka = Ka || Function("return this")() || eval("this")
        } catch (t) {
        ...
        var r = n(0),
            ...
            h = function(t) {
                var i = 10 * (1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 1);
                return {
            ...
            a = function(t) {
                var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : .05,
                    u = t.slice(0, 1);
                return t.slice(1).forEach(function(t) {
                    var i = u[u.length - 1],
                        n = l(t, i);
                    if (e < n)
                        for (var r = Math.ceil(n / e), o = n / r, s = 0; s < r; s++) u.push(p(t, i, -1 * o * (s + 1)));
                    else u.push(t)
                }), u
            },
            c = function(t) {
                for (var i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 30, n = d(t) / (i - 1), r = [t[0]], o = v(t), s = t.slice(1), e = 0; e < i - 2; e++)
            ...
            f = function(t) {
                ...
                var s = [t[0], t[1]];
                return t.slice(2).forEach(function(t, i) {
                    var n = s.length,
                        r = u(t, s[n - 1]),
                        o = u(s[n - 1], s[n - 2]);
        ...
        t.exports = {
            ...
            frechetDist: function(r, o) {
                ...
                return function t(i, n) {
                    return -1 < s[i][n] || (s[i][n] = 0 === i && 0 === n ? l(r[0], o[0]) : 0 < i && 0 === n ? Math.max(t(i - 1, 0), l(r[i], o[0])) : 0 === i && 0 < n ? Math.max(t(0, n - 1), l(r[0], o[n])) : 0 < i && 0 < n ? Math.max(Math.min(t(i - 1, n), t(i - 1, n - 1), t(i, n - 1)), l(r[i], o[n])) : 1 / 0), s[i][n]
            ...
            normalizeCurve: function(t) {
                var i = c(t),
                    n = {
                        x: e(i.map(function(t) {
                            return t.x
                        })),
                        y: e(i.map(function(t) {
                            return t.y
                        }))
                    },
                    r = i.map(function(t) {
                    ...
                    o = Math.sqrt(e([Math.pow(r[0].x, 2) + Math.pow(r[0].y, 2), Math.pow(v(r).x, 2) + Math.pow(v(r).y, 2)])),
                    s = r.map(function(t) {
                        return {
                            x: t.x / o,
                            y: t.y / o
        ...
        (function(n) {
            ...
            t.exports = {
                ...
                urlIdRef: function(t) {
                    var i = "";
                    return n.location && n.location.href && (i = n.location.href.replace(/#[^#]*$/, "")), "url(" + i + "#" + t + ")"
                }
            }
        }).call(i, n(1))
    }, function(t, i, n) {
        ...
        var u = n(5),
            e = n(0).objRepeat,
            h = function(t, i, n) {
                return [new u("character." + t + ".strokes", e({
                    opacity: 1,
                    displayPortion: 1
                }, i.strokes.length), {
                    duration: n,
            ...
            a = function(t, i, n) {
                return [new u("character." + t + ".opacity", 0, {
                    duration: n,
                    force: !0
                })].concat(h(t, i, 0))
            },
            c = function(t, i, n) {
                ...
                return [new u("character." + t, {
                    opacity: 1,
                    strokes: s({}, r, {
                        displayPortion: 0,
                        opacity: 1
                    })
                }), new u("character." + t + ".strokes." + r + ".displayPortion", 1, {
                    duration: o
                })]
            },
            f = function(n, t, i, r, o) {
                var s = a(n, t, i);
                return (s = s.concat(h(n, t, 0))).push(new u("character." + n, {
                    opacity: 1,
                    strokes: e({
                        opacity: 0
                    }, t.strokes.length)
                    ...
                    0 < i && s.push(new u.Delay(o)), s = s.concat(c(n, t, r))
                }), s
            };
        t.exports = {
            showStrokes: h,
            ...
            highlightStroke: function(t, i, n) {
                ...
                return [new u("character.highlight.strokeColor", i), new u("character.highlight", {
                    opacity: 1,
                    strokes: s({}, r, {
                        displayPortion: 0,
                        opacity: 0
            ...
            animateSingleStroke: function(o, s, t, i) {
                return [new u("character." + o, function(t) {
                    for (var i = t.character[o], n = {
                            opacity: 1,
                            strokes: {}
                        }, r = 0; r < s.strokes.length; r++) n.strokes[r] = {
            ...
            showStroke: function(t, i, n) {
                return [new u("character." + t + ".strokes." + i, {
                    displayPortion: 1,
                    opacity: 1
                }, {
                    duration: n,
        ...
        function h(t, i) {
            ...
            this.scope = t, this.f = i, this.v = n.duration || 0, this.w = n.force, this.k = 0, this.C = this.M.bind(this), this.S = null
        }
        ...
        h.prototype.run = function(t) {
            var i = this;
            return this.O || this.A(t), 0 === this.v && t.updateState(this.O), 0 === this.v || function t(i, n) {
                for (var r in n)
            ...
            }(t.state, this.O) ? Promise.resolve() : (this.F = t, this.D = t.state, this.j = s(), this.T = e(this.C), new Promise(function(t) {
                i.I = t
            }))
        }, h.prototype.pause = function() {
            null === this.S && (this.T && u(this.T), this.S = s())
        }, h.prototype.resume = function() {
            null !== this.S && (this.T = e(this.C), this.k += s() - this.S, this.S = null)
        }, h.prototype.M = function(t) {
            if (null === this.S) {
                var i, n = Math.min(1, (t - this.j - this.k) / this.v);
                if (1 === n) this.F.updateState(this.O), this.T = null, this.cancel(this.F);
                else {
                    var r = (i = n, -Math.cos(i * Math.PI) / 2 + .5);
                    this.F.updateState(function t(i, n, r) {
                        var o = {};
                        for (var s in n) {
                            var e = n[s],
                                u = i[s];
                            o[s] = 0 <= e ? r * (e - u) + u : t(u, e, r)
                        }
                        return o
                    }(this.D, this.O, r)), this.T = e(this.C)
                }
            }
        }, h.prototype.A = function(t) {
            var i = this.f;
            "function" == typeof this.f && (i = this.f(t.state)), this.O = o(this.scope, i)
        }, h.prototype.cancel = function(t) {
            this.I && this.I(), this.I = null, this.T && u(this.T), this.T = null, this.w && (this.O || this.A(t), t.updateState(this.O))
        }, a.prototype.pause = function() {
            if (!this.P) {
                var t = s() - this.j;
                this.v = Math.max(0, this.v - t), clearTimeout(this.W), this.P = !0
            }
        }, a.prototype.resume = function() {
            var t = this;
            this.P && (this.j = s(), this.W = setTimeout(function() {
                return t.cancel()
            }, this.v), this.P = !1)
            ...
            return this.j = s(), this.W = setTimeout(function() {
                return i.cancel()
            }, this.v), t
        }, a.prototype.cancel = function() {
            clearTimeout(this.W), this.I && this.I(), this.I = !1
        }, h.Delay = a, t.exports = h
    }, function(t, i, n) {
        "use strict";

        function r() {}
        r.prototype.z = function(t) {
            return .999 * this.R * (1 - t)
        ...
        (function(i) {
            ...
            t.prototype.addPointerStartListener = function(i) {
                ...
                this.node.addEventListener("mousemove", function(t) {
                    i(n.U(t, n._))
                }), this.node.addEventListener("touchmove", function(t) {
                    i(n.U(t, n.K))
                })
            }, t.prototype.addPointerEndListener = function(t) {
                i.document.addEventListener("mouseup", t), i.document.addEventListener("touchend", t)
        ...
        t.exports = {
            drawPath: function(i, t) {
                ...
                var n = t[0],
                    r = t.slice(1);
                i.moveTo(n.x, n.y), r.forEach(function(t) {
                    i.lineTo(t.x, t.y)
                }), i.stroke()
            },
            pathStringToCanvas: function(t) {
                ...
                return i.forEach(function(t) {
                        var i, n = t.split(/\s+/),
                            r = (i = n, Array.isArray(i) ? i : Array.from(i)),
                            o = r[0],
                            s = r.slice(1).map(function(t) {
                                return parseFloat(t)
                            });
                        "M" === o ? e.push(function(t) {
                            return t.moveTo.apply(t, s)
                        }) : "L" === o ? e.push(function(t) {
                            return t.lineTo.apply(t, s)
                        }) : "C" === o ? e.push(function(t) {
                            return t.bezierCurveTo.apply(t, s)
                        }) : "Q" === o && e.push(function(t) {
        ...
        function g() {
            if (0 < arguments.length) {
                ...
                1 < arguments.length && (i = "string" == typeof(arguments.length <= 1 ? void 0 : arguments[1]) ? (console.warn("Using new HanziWriter() to set a character is deprecated. Use HanziWriter.create() instead"), t = arguments.length <= 1 ? void 0 : arguments[1], (arguments.length <= 2 ? void 0 : arguments[2]) || {}) : arguments.length <= 1 ? void 0 : arguments[1]), this.N(n, i), t && this.setCharacter(t)
            }
        }
        g.prototype.showCharacter = function() {
            var t = this,
                i = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
            return this.B.showCharacter = !0, this.G(function() {
                return t.F.run(f.showCharacter("main", t.V, "number" == typeof i.duration ? i.duration : t.B.strokeFadeDuration)).then(function(t) {
            ...
            var t = this,
                i = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
            return this.B.showCharacter = !1, this.G(function() {
                return t.F.run(f.hideCharacter("main", t.V, "number" == typeof i.duration ? i.duration : t.B.strokeFadeDuration)).then(function(t) {
                    return d(i.onComplete, t)
                })
            })
            ...
            var t = this,
                i = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
            return this.cancelQuiz(), this.G(function() {
                return t.F.run(f.animateCharacter("main", t.V, t.B.strokeFadeDuration, t.B.strokeAnimationSpeed, t.B.delayBetweenStrokes)).then(function(t) {
                    return d(i.onComplete, t)
                })
            })
            ...
            return this.cancelQuiz(), this.G(function() {
                return i.F.run(f.animateSingleStroke("main", i.V, t, i.B.strokeAnimationSpeed)).then(function(t) {
            ...
            return this.G(function() {
                return i.F.run(f.highlightStroke(i.V.strokes[t], i.B.highlightColor, i.B.strokeHighlightSpeed)).then(function(t) {
                    return d(n.onComplete, t)
                })
            })
            ...
            return this.cancelQuiz(), this.G(function() {
                return t.F.run(f.animateCharacterLoop("main", t.V, t.B.strokeFadeDuration, t.B.strokeAnimationSpeed, t.B.delayBetweenStrokes, t.B.delayBetweenLoops), {
                    loop: !0
                })
            })
            ...
            var t = this,
                i = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
            return this.B.showOutline = !0, this.G(function() {
                return t.F.run(f.showCharacter("outline", t.V, "number" == typeof i.duration ? i.duration : t.B.strokeFadeDuration)).then(function(t) {
                    return d(i.onComplete, t)
                })
            })
            ...
            var t = this,
                i = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
            return this.B.showOutline = !1, this.G(function() {
                return t.F.run(f.hideCharacter("outline", t.V, "number" == typeof i.duration ? i.duration : t.B.strokeFadeDuration)).then(function(t) {
                    return d(i.onComplete, t)
                })
            })
            ...
            return this.G(function() {
                var t = "number" == typeof u.duration ? u.duration : e.B.strokeFadeDuration,
                    i = s;
                "radicalColor" !== o || s || (i = e.B.strokeColor);
                var n = y(i);
                e.B[o] = s;
                var r = f.updateColor(o, n, t);
                return "radicalColor" !== o || s || (r = r.concat(f.updateColor(o, null, 0))), e.F.run(r).then(function(t) {
            ...
            var t = this,
                i = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
            this.G(function() {
                t.cancelQuiz(), t.$ = new r(t.V, t.F, t.q), t.$.startQuiz(l({}, t.B, i))
            })
        }, g.prototype.cancelQuiz = function() {
            this.$ && (this.$.cancel(), this.$ = null)
        }, g.prototype.setCharacter = function(n) {
            var r = this;
            return this.cancelQuiz(), this.J = n, this.Q && this.Q.destroy(), this.F && this.F.cancelAll(), this.Q = null, this.Z = this.X.loadCharData(n).then(function(t) {
                if (!r.X.loadingFailed) {
                    r.V = s(n, t), r.q = new e(r.B);
                    var i = new r.Y.HanziWriterRenderer(r.V, r.q);
                    r.Q = i, r.F = new o(r.V, r.B, function(t) {
                        i.render(t)
                    }), r.Q.mount(r.target, r.F.state), r.Q.render(r.F.state)
                }
            }), this.Z
            ...
            return this.Y = {
                HanziWriterRenderer: r.HanziWriterRenderer || n.HanziWriterRenderer,
                createRenderTarget: r.createRenderTarget || n.createRenderTarget
            }, this.target = this.Y.createRenderTarget(t, i.width, i.height), this.B = this.tt(i), this.X = new c(this.B), this.it(), this.$ = null, this
        }, g.prototype.tt = function(t) {
            var i = l({}, w, t);
            return t.strokeAnimationDuration && !t.strokeAnimationSpeed && (i.strokeAnimationSpeed = 500 / i.strokeAnimationDuration), t.strokeHighlightDuration && !t.strokeHighlightSpeed && (i.strokeHighlightSpeed = 500 / i.strokeHighlightDuration), t.highlightCompleteColor || (i.highlightCompleteColor = i.highlightColor), this.nt(i)
            ...
            var i = this;
            if (this.X.loadingFailed) throw Error("Failed to load character data. Call setCharacter and try again.");
            ...
            this.target.addPointerStartListener(function(t) {
                !i.isLoadingCharData && i.$ && (t.preventDefault(), i.rt("startUserStroke", t.getPoint()))
            }), this.target.addPointerMoveListener(function(t) {
                !i.isLoadingCharData && i.$ && (t.preventDefault(), i.rt("continueUserStroke", t.getPoint()))
            ...
            var n = new g(t, 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {});
        ...
        g.loadCharacterData = function(t) {
            var i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
                n = void 0;
            return n = k && m === i ? k : new c(l({}, w, i)), m = i, (k = n).loadCharData(t)
        ...
        e.prototype.updateState = function(t) {
            ...
            return this.cancelMutations(s), new Promise(function(t) {
                var i = {
                    et: !0,
                    ut: 0,
                    I: t,
            ...
            if (i.et) {
                var n = i.ht;
                if (i.ut >= n.length) {
                    if (!i.at) return i.et = !1, this.st = this.st.filter(function(t) {
                        return t !== i
                    }), void i.I({
                        canceled: !1
                    });
            ...
            this.st.forEach(function(n) {
                n.ct.forEach(function(i) {
                    t.forEach(function(t) {
                        (0 <= i.indexOf(t) || 0 <= t.indexOf(i)) && r.lt(n)
                    })
                })
            })
            ...
            i.et = !1;
            for (var t = i.ut; t < i.ht.length; t++) i.ht[t].cancel(this);
            i.I && i.I({
                canceled: !0
        ...
        var s = function(t, i) {
                ...
                if (Symbol.iterator in Object(t)) return function(t, i) {
                    var n = [],
                        ...
                        s = void 0;
                    try {
                        for (var e, u = t[Symbol.iterator](); !(r = (e = u.next()).done) && (n.push(e.value), !i || n.length !== i); r = !0);
                    } catch (t) {
                        o = !0, s = t
                    } finally {
                        try {
            ...
            o = function(o) {
                return o.strokes.map(function(t, i) {
                    var n, r = o.medians[i].map(function(t) {
                        var i = s(t, 2);
                        return {
                            x: i[0],
                            y: i[1]
                    ...
                    return new e(t, r, i, (n = i, o.radStrokes && 0 <= o.radStrokes.indexOf(n)))
                })
            };
        ...
        function r(t) {
            this.B = t, this.width = t.width, this.height = t.height, this.dt()
        }
        r.prototype.convertExternalPoint = function(t) {
            ...
            this.xOffset = -1 * t[0].x * this.scale + u, this.yOffset = -1 * t[0].y * this.scale + h
        }, t.exports = r
    }, function(t, i, n) {
        "use strict";
        var r = n(16),
        ...
        v.prototype.startQuiz = function(t) {
            this.et = !0, this.B = t, this.pt = 0, this.yt = 0, this.wt = 0, this.gt = [], this.F.run(h.startQuiz(this.V, t.strokeFadeDuration))
            ...
            var n = u();
            this.kt = new o(n, i, t), this.F.run(h.startUserStroke(n, i))
            ...
            if (this.kt)
                if (this.F.run(h.removeUserStroke(this.kt.id, this.B.drawingFadeDuration)), 1 !== this.kt.points.length) {
                    var t = this.mt(),
                        i = 0 < this.F.state.character.outline.opacity;
                    r(this.kt, this.V, this.pt, {
                        isOutlineVisible: i,
                        leniency: this.B.leniency
                    }) ? this.bt(t) : (this.Ct(), this.yt >= this.B.showHintAfterMisses && this.F.run(h.highlightStroke(t, this.B.highlightColor, this.B.strokeHighlightSpeed))), this.kt = null
                } else this.kt = null
        }, v.prototype.cancel = function() {
            this.et = !1, this.kt && this.F.run(h.removeUserStroke(this.kt.id, this.B.drawingFadeDuration))
            ...
            var i = c.showStroke("main", this.pt, this.B.strokeFadeDuration);
            this.pt += 1, this.yt = 0, this.pt === this.V.strokes.length && (this.et = !1, e(this.B.onComplete, {
                character: this.V.symbol,
                totalMistakes: this.wt
            }), this.B.highlightOnComplete && (i = i.concat(h.highlightCompleteChar(this.V, this.B.highlightCompleteColor, 2 * this.B.strokeHighlightDuration)))), this.F.run(i)
        }, v.prototype.Ct = function() {
            this.yt += 1, this.wt += 1, e(this.B.onMistake, {
                character: this.V.symbol,
                strokeNum: this.pt,
                mistakesOnStroke: this.yt,
                totalMistakes: this.wt,
        ...
        var r = n(0),
            ...
            A = o.length,
            F = function(t, i) {
                var n, r, o, s = (r = [], o = (n = t)[0], n.slice(1).forEach(function(t) {
                        r.push(c(t, o)), o = t
                    }), r),
                    e = i.getVectors(),
                    u = s.map(function(i) {
            ...
            D = [Math.PI / 16, Math.PI / 32, 0, -1 * Math.PI / 32, -1 * Math.PI / 16],
            p = function(t, i, n) {
                var r = n.leniency,
                    o = void 0 === r ? 1 : r,
                    ...
                    h = u <= 350 * (e || 0 < i.strokeNum ? .5 : 1) * o;
                if (!h) return {
                    isMatch: !1,
                    avgDist: u
                };
                var a, c, f, v, l, d, p, y, w, g, k, m, b = (a = t, f = o, v = P((c = i).getStartingPoint(), a[0]), l = P(c.getEndingPoint(), a[a.length - 1]), v <= 250 * f && l <= 250 * f),
                    C = F(t, i),
                    M = (d = t, p = i.points, y = o, w = x(d), g = x(p), k = 1 / 0, D.forEach(function(t) {
                        var i = j(w, O(g, t));
                        i < k && (k = i)
                    }), k <= .4 * y),
                    S = (m = i, .35 <= o * (A(t) + 25) / (m.getLength() + 25));
                return {
                    isMatch: h && b && C && M && S,
                    avgDist: u
                }
        ...
        t.exports = function(t, i, n) {
            ...
            for (var e = i.strokes.slice(n + 1), u = s.avgDist, h = 0; h < e.length; h++) {
                var a = p(o, e[h], r);
                a.isMatch && a.avgDist < u && (u = a.avgDist)
            }
            if (u < s.avgDist) {
                var c = .6 * (u + s.avgDist) / (2 * s.avgDist),
                    f = (r.leniency || 1) * c,
                    v = l({}, r, {
                        leniency: f
                    });
        ...
        t.exports = {
            highlightCompleteChar: function(t, i, n) {
                return [new r("character.highlight.strokeColor", i)].concat(o.hideCharacter("highlight", t)).concat(o.showCharacter("highlight", t, n / 2)).concat(o.hideCharacter("highlight", t, n / 2))
            },
            ...
            Object.keys(this.Pt).forEach(function(t) {
                ...
                if (s[t]) {
                    var i = u({
                        ...
                        n = o.Pt[t];
                    n || ((n = new e).mount(o.xt, i), o.Pt[t] = n), n.render(i)
                }
            })
        ...
        function s(t) {
            this.Ot = {}, this.At = t.strokes.map(function(t) {
                return new o(t)
            })
        }
        s.prototype.mount = function(t) {
            var n = t.createSubRenderTarget();
            this.Ft = n.svg, this.At.forEach(function(t, i) {
                t.mount(n)
            })
        }, s.prototype.render = function(t) {
            if (t !== this.Ot) {
                t.opacity !== this.Ot.opacity && (this.Ft.style.opacity = t.opacity, r || (0 === t.opacity ? this.Ft.style.display = "none" : 0 === this.Ot.opacity && this.Ft.style.removeProperty("display")));
                var i = !this.Ot || t.strokeColor !== this.Ot.strokeColor || t.radicalColor !== this.Ot.radicalColor;
                if (i || t.strokes !== this.Ot.strokes)
                    for (var n = 0; n < this.At.length; n++) !i && this.Ot.strokes && t.strokes[n] === this.Ot.strokes[n] || this.At[n].render({
        ...
        function a(t) {
            ...
            this.Dt = e.createElm("path"), this.Tt = e.createElm("clipPath"), this.Et = e.createElm("path");
            var i = "mask-" + r();
            e.attr(this.Tt, "id", i), e.attr(this.Et, "d", this.L.path), this.Dt.style.opacity = 0, e.attr(this.Dt, "clip-path", e.urlIdRef(i));
            var n = s(this.L.points, 100);
            return e.attr(this.Dt, "d", u(n)), e.attrs(this.Dt, {
                stroke: "#FFFFFF",
                "stroke-width": 200,
                fill: "none",
            ...
            }), this.Tt.appendChild(this.Et), t.defs.appendChild(this.Tt), t.svg.appendChild(this.Dt), this
        }, a.prototype.render = function(t) {
            if (t !== this.Ot) {
                t.displayPortion !== this.Ot.displayPortion && (this.Dt.style.strokeDashoffset = this.z(t.displayPortion));
                var i = this.H(t);
                if (i !== this.H(this.Ot)) {
                    var n = i.r,
                        r = i.g,
                ...
                t.opacity !== this.Ot.opacity && (this.Dt.style.opacity = t.opacity), this.Ot = t
            }
        }, t.exports = a
    }, function(t, i, n) {
        "use strict";
        ...
        r.prototype.mount = function(t) {
            ...
            if (t !== this.Ot) {
                if (t.strokeColor !== this.Ot.strokeColor || t.strokeWidth !== this.Ot.strokeWidth) {
                    var i = t.strokeColor,
                        n = i.r,
                        r = i.g,
                        o = i.b,
                ...
                t.opacity !== this.Ot.opacity && e.attr(this.It, "opacity", t.opacity), t.points !== this.Ot.points && e.attr(this.It, "d", u(t.points)), this.Ot = t
            }
        ...
        (function(u) {
            ...
            function c(t, i) {
                this.svg = t, this.defs = i, this.node = t, this.node.createSVGPoint && (this.Wt = this.node.createSVGPoint())
            }(c.prototype = Object.create(n.prototype)).createSubRenderTarget = function() {
                var t = h("g");
                return this.svg.appendChild(t), new c(t, this.defs)
            }, c.prototype._ = function(t) {
                if (this.Wt) {
                    this.Wt.x = t.clientX, this.Wt.y = t.clientY;
                    var i = this.Wt.matrixTransform(this.node.getScreenCTM().inverse());
                    return {
                        x: i.x,
                        y: i.y
                    }
                ...
                if (this.Wt) {
                    this.Wt.x = t.touches[0].clientX, this.Wt.y = t.touches[0].clientY;
                    var i = this.Wt.matrixTransform(this.node.getScreenCTM().inverse());
                    return {
                        x: i.x,
                        y: i.y
                ...
                var i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "100%",
                    ...
                    r = void 0,
                    o = t;
                if ("string" == typeof t && (o = u.document.getElementById(t)), !o) throw new Error("HanziWriter target element not found: " + t);
                var s = o.nodeName.toUpperCase();
                "SVG" === s || "G" === s ? r = o : (r = h("svg"), o.appendChild(r)), a(r, {
                    width: i,
                    height: n
                });
                var e = h("defs");
        ...
        function o(t, i) {
            this.V = t, this.q = i, this.Mt = new r(t), this.St = new r(t), this.jt = new r(t)
        }
        o.prototype.mount = function(t) {
            this.zt = t
        }, o.prototype.Rt = function(t) {
            var i = this.zt.getContext();
            i.clearRect(0, 0, this.q.width, this.q.height), i.save(), i.translate(this.q.xOffset, this.q.height - this.q.yOffset), i.transform(1, 0, 0, -1, 0, 0), i.scale(this.q.scale, this.q.scale), t(i), i.restore(), i.draw && i.draw()
        ...
        }, o.prototype.destroy = function() {}, t.exports = o
    }, function(t, i, n) {
        "use strict";
        var r = n(28);
        ...
        o.prototype.render = function(t, i) {
            if (!(i.opacity < .05))
                for (var n = 0; n < this.At.length; n++) this.At[n].render(t, {
        ...
        (function(n) {
            ...
            function s(t) {
                var i = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1];
                this.L = t, this.R = t.getLength() + 100, i && n.Path2D ? this.Ht = new n.Path2D(this.L.path) : this.Lt = o(this.L.path), this.Ut = r(this.L.points, 100)
            }(s.prototype = Object.create(i.prototype)).render = function(t, i) {
                if (!(i.opacity < .05)) {
                    t.save(), this.Ht ? t.clip(this.Ht) : (this.Lt(t), t.globalAlpha = 0, t.stroke(), t.clip());
                    var n = this.H(i),
                        r = n.r,
                        o = n.g,
                        s = n.b,
                        e = n.a,
                        u = 1 === e ? "rgb(" + r + "," + o + "," + s + ")" : "rgb(" + r + "," + o + "," + s + "," + e + ")",
                        h = this.z(i.displayPortion);
                    t.globalAlpha = i.opacity, t.strokeStyle = u, t.fillStyle = u, t.lineWidth = 200, t.lineCap = "round", t.lineJoin = "round", t.setLineDash([this.R, this.R], h), t.lineDashOffset = h, a(t, this.Ut), t.restore()
                }
            }, e.exports = s
        }).call(t, u(1))
    }, function(t, i, n) {
        ...
        t.exports = function(t, i) {
            if (!(i.opacity < .05)) {
                var n = i.strokeColor,
                    ...
                    s = n.b,
                    e = n.a;
                t.save(), t.globalAlpha = i.opacity, t.lineWidth = i.strokeWidth, t.strokeStyle = "rgba(" + r + "," + o + "," + s + "," + e + ")", t.lineCap = "round", t.lineJoin = "round", u(t, i.points), t.restore()
            }
        }
    }, function(i, t, n) {
        "use strict";
        (function(s) {
            ...
            function e(t) {
                this.node = t
            }(e.prototype = Object.create(t.prototype)).getContext = function() {
                ...
                var i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "100%",
                    ...
                    r = void 0,
                    o = t;
                if ("string" == typeof t && (o = s.document.getElementById(t)), !o) throw new Error("HanziWriter target element not found: " + t);
		return "CANVAS" === o.nodeName.toUpperCase() ? r = o : (r = s.document.createElement("canvas"), o.appendChild(r)), r.setAttribute("width", i), r.setAttribute("height", n), new e(r)
            }, i.exports = e
        }).call(t, n(1))
    }, function(t, i, n) {
        "use strict";
		...
		//https://stackoverflow.com/questions/50513063/anki-and-ankidroid-importing-json-from-collection-media-with-javascript
		//https://github.com/krmanik/Anki-xiehanzi
                // Note:  char_data variable come from other .js file
        ...
        function o(t) {
            this._t = 0, this.B = t, this.Kt = !1, this.loadingFailed = !1
        }
        o.prototype.Nt = function(t, i) {
            ...
            return new Promise(function(t, i) {
                ...
                return n.Kt = !1, r(n.B.onLoadCharDataSuccess, t), t
            }, function(t) {
                if (n.Kt = !1, n.loadingFailed = !0, r(n.B.onLoadCharDataError, t), !n.B.onLoadCharDataError) {
                    if (t instanceof Error) throw t;
                    var i = new Error("Failed to load char data for " + n.Vt);
                    throw i.reason = t, i
                }
            })
            ...
            this.Vt = t;
            var i = this.Gt();
            return this.loadingFailed = !1, this.Kt = !0, this._t++, this.Nt(t, this._t), i
        }, t.exports = o
    }])
});

var stroke_color = getComputedStyle(document.querySelector(".stroke-color")).color;
var outline_color = getComputedStyle(document.querySelector(".outline-color")).color;
var drawing_color = getComputedStyle(document.querySelector(".drawing-color")).color;
...
// check slider2 and related function above 
var char_height = vh(charHW);
var char_width = vw(charHW);
//var char_height = 400;
//var char_width = 400;
...
async function writeFunction(c) {
    ...
    return new Promise(function(resolve, reject) {
        ...
        var showing = show_outline;
        document.getElementById('btnShowHideOutline').onclick = function() {
            if (showing) {
                showing = false;
                writer.hideOutline();
            } else {
